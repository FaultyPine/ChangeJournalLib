...
typedef void(*UsnRecordCallback)(const Journal& journal, PUSN_RECORD record, void* userData);
// reads journal entries into the given bufferuntil either we've read all the entries,
// or numReadAttempts is reached, calling cb on each record
bool ReadJournal(
